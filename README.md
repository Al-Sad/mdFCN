...
### Main_1_FC.m
-   This main script calculates the static and dynamic functional connectivity (FC) of each neonate's cortical signals. Note that the neonate’s raw EEG and neurocognitive scores are not supplied.
...
### Main_3_extraction.m
-   This main script extracts latent networks from mdFCNs by NMF and selects the best model order.
...
-   *nmfnnls_mod.m*: It is a modified version of nmfnnls.m in *NMF\nmfv1_4*.
### CPD
